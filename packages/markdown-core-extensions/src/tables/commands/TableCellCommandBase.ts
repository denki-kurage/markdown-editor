...
import { MarkdownTableContent, TableCell, TableCellInfo, TablePositionDirections, TableRowBase } from "../MarkdownTableContent";
import { MarkdownTableRenderMode } from "../MarkdownTableConverter";
import { TablePosition } from "../TablePosition";
import { TableCommandBase } from "./TableCommandBase";
import { IFormattableParameter, ISelection, ITextReplacer, MarkdownRange, TextReplacer } from "@kurage/markdown-core";
...
class FormattableParameter implements IFormattableParameter
{
	...
	public constructor(
		...
		private readonly replacer: ITextReplacer)
	{
